...
<html>
	...
	<body>
        <div class="container"> 
			...
			<div class="row">
				<div class="col-2">
                    <img src="../assets/images/seller_signup.jpg" alt="login image">
                </div>
				<div class="col-2">
                    <div class="formBox">
                    <h1>SignUp Seller</h1>
                        <form action="../auth/signup-seller" method="POST">
                            
                            <p>Restaurant name</p>
                            <input type="text" name="resname" placeholder="Enter restaurant name">
                                <span class="invalidFeedback">
                                    <?php echo $usernameError;?>
                                </span>

                            <p>Restaurant address</p>
                            <input type="text" name="resaddress" placeholder="Enter restaurant address"> 

                            <p>Seller name</p>
                            <input type="text" name="sellername" placeholder="Enter seller name"> 

                            <p>Phone Number</p>
                            <input type="text" name="tele" placeholder="Enter seller name"> 
                            ...
                            <input type="hidden" name="userTypeId" value="4">
