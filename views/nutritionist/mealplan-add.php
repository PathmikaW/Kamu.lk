...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            html += '<td><input class="form-control" type="text" name="food[]" size="10" value="" autocomplete="off"  required> </td>';
        ...
        <div class="food-view">
            ...
            <form  action="../nutritionist/mealplan-add?id=<?php echo $request_id;?>" method="post">
                <label>Meal Plan Name</label>
                    <input class="form-control" type="text" name="mealPlanName" size="50"
                ...
                <table id="food1">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="food[]" size="10" value="" autocomplete="off"  required>  
                        </td>
                        <td>
