    ...
    <div class="user-dashboard">
     ...
     <div class="content">
            <div class="food-form form-container">
                ...
                <form class="form" action="../user/posts" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="size" value="1000000">
                    <div class="form-group">
                        
                        <label>Title</label>
                            <input class="form-control"input type="text" name="txt_image_name"><br>
                    

                        <label>Upload your document</label>
                            <input input type="file" name="txt_image" placeholder="Choose"><br>
                    </div>
